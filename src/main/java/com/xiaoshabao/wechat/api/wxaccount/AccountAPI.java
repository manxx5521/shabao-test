...
public class AccountAPI {
	 ...
	 */
	public static QrcodeResult createQrcodeTemp(String accessToken, String scene_id, String expire_seconds) throws WeixinReqException {
		...
		qrcodeCreate.setAction_name("QR_SCENE");
	 ...
	 * @param action_name 二维码类型，QR_SCENE为临时,QR_LIMIT_SCENE为永久,QR_LIMIT_STR_SCENE为永久的字符串参数值。参考当前方法静态变量<br>
	 * @param expire_seconds 该二维码有效时间，以秒为单位。 最大不超过2592000（即30天），此字段如果不填，则默认有效期为30秒。临时二维码有效
	 * @return
	 * @throws WeixinReqException
	 */
	public static QrcodeResult createQrcode(String accessToken, String scene_id,String scene_str,
			String action_name, String expire_seconds) throws WeixinReqException {
		QrcodeCreate qrcodeCreate = new QrcodeCreate();
		qrcodeCreate.setAccess_token(accessToken);
		QrcodeActionInfo q = new QrcodeActionInfo();
		QrcodeScene ss = new QrcodeScene();
	 ...
	 * @throws WeixinReqException
	 */
	public static String getShortUrl(String accessToken,String longUrl) throws WeixinReqException{
