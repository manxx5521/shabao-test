...
public class WeiXinReqService {
	...
	private WeiXinReqService() throws WeixinReqException {
		try {
	 ...
	 */
	public static WeiXinReqService getInstance() throws WeixinReqException {
	...
	public String doWeinxinReq(WeixinReqParam weixinReqParam)
		...
		if (!weixinReqParam.getClass().isAnnotationPresent(ReqType.class)) {
			...
			throw new WeixinReqException("传入的参数不对");
		}
		...
		if (objConfig == null) {
			...
			throw new WeixinReqException("没有找到相应配置信息");
		}
	 ...
	 * @throws WeixinReqException 
	 */
	public JSONObject doWeinxinReqJson(WeixinReqParam weixinReqParam) throws WeixinReqException{
		...
		if(error !=null && Integer.parseInt(error.toString())!=0){
			throw new WeixinReqException(result.toString());
		}
		return result;
	}
