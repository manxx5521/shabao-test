...
public abstract class UpgradeServiceImpl implements UpgradeService {
	...
	protected AjaxResult upgradeApplication(Integer upgradeId,
		...
		unzip(upgradeEntity, UpgradeConstants.getFilePath(upgradeEntity
				.getServerPath()), UpgradeConstants.getFileTempPath(
	...
	protected void overrideFiles(UpgradeEntity upgradeEntity) {
		try {
			File configFile = new File(
					UpgradeConstants.getSpecialConfigPath(upgradeEntity
							.getServerPath()));
