...
/* disallowListCache缓存robot不允许搜索的URL。 Robot协议在Web站点的根目录下设置一个robots.txt文件,
 ...
 private boolean isRobotAllowed(URL urlToCheck) { 
  ...
  // 解析页面并找出链接
  private ArrayList< String> retrieveLinks(URL pageUrl, String pageContents, @SuppressWarnings("rawtypes") HashSet crawledList,
    boolean limitHost)
  {
    // 用正则表达式编译链接的匹配模式。
 ...
 // 搜索下载Web页面的内容，判断在该页面内有没有指定的搜索字符串
  ...
  public static void main(String[] args) {
	 ...
	 */
    //startUrl maxUrl searchString
    SearchCrawler crawler = new SearchCrawler("",1,"");
