  ...
  public void test() {
    ...
    try {
      ...
      // .setRoutePlanner(routePlanner)
        .build();
      RequestConfig requestConfig = RequestConfig.custom().setCookieSpec("easy").setSocketTimeout(5000) // socket超时
      ...
      responseContent = EntityUtils.toString(entity, MZhuatu.DEFAULT_CHARSET);// 获得响应内容
    } catch (Exception e) {
      e.printStackTrace();
