...
*/
 ...
 /*
  * lucene的使用存在部分问题，等待修改
  *lucene的最新版使用见： http://www.cnblogs.com/jwlfpzj/p/6762593.html
  * 
  */
public class LuceneLink {
 /*
    ...
    private Logger logger=Logger.getLogger(LuceneLink.class);
     
    private LuceneLink(){
         
        logger.debug("实例化对象"+LuceneLink.class.getName());
    }
    *//**
     * 返回当前类的一个实例
     * @return
     *//*
    public static LuceneLink getInstance(){
         
    	LuceneLink link=new LuceneLink();
        loadConfig(link);
        return link;
    }
    ...
    *//**
     ...
     * @return
     *//*
    private static LuceneLink loadConfig(LuceneLink link){
         
            link.imagepath= "E:/images3";
    ...
    *//**
     ...
     *//**
     ...
     public boolean hasOne(String url) throws ParseException, IOException{
        ...
        if(indexSearcher!=null){
            ...
            Query query=parser.parse(LuceneLink.md5(url));
     ...
     *//**
     ...
     public void indexUrl(String url) throws CorruptIndexException, LockObtainFailedException, IOException{
         ...
         Field field=new Field("url", LuceneLink.md5(url), Store.NO, Index.ANALYZED);
         document.add(field);
    ...
    public static void main(String[] args) {
        ...
        LuceneLink link=LuceneLink.getInstance();
       link.connect(url);
    }
