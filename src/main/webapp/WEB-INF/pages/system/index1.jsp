...
<![endif]-->
<!-- Morris显示图表 时序图 -->
<link href="${ctx}/resources/plugins/morris/morris.css" rel="stylesheet">
</head>
<body class="gray-bg">
   ...
   <%--  <script src="${ctx}/resources/plugins/flot/jquery.flot.tooltip.min.js"></script>
    ...
    <%-- <script src="${ctx}/resources/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctx}/resources/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script> --%>
    <script>
    $(function() {
        $(".chart").easyPieChart({
			barColor : "#f8ac59",
