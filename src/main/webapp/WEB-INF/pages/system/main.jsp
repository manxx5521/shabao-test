...
<body class="fixed-sidebar full-height-layout gray-bg"
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-edit"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="#">编辑器 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
							...
							<ul class="dropdown-menu dropdown-messages">
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle"
											src="${ctx}/resources/system/img/a7.jpg">
										</a>
								...
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle"
											src="${ctx}/resources/system/img/a4.jpg">
										</a>
										<div class="media-body ">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="index1.html?v=4.0" frameborder="0" data-id="index1.html"
					seamless></iframe>
			</div>
			<div class="footer">
				<div class="pull-right">
					&copy; 2014-2015 <a href="http://www.zi-han.net/" target="_blank">ShaBao</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
						...
						<div>
								...
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${ctx}/resources/system/img/a1.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${ctx}/resources/system/img/a2.jpg">
									</div>
									<div class="media-body">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${ctx}/resources/system/img/a3.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${ctx}/resources/system/img/a8.jpg">
									</div>
									<div class="media-body">
	...
	<script src="${ctx}/resources/system/index/menu.js" type="text/javascript"></script>
	<script type="text/javascript">
		var menuList = $.parseJSON('${menuList}');
		//调用加载菜单
		var webRoot='${ctx}';
		getMenu(menuList);
	</script>
